...
**Scorecard (auto-generated from `evidence_scorecard.json`): 51 Zeilen — 26 consistent, 4 tension, 7 null, 13 data_limited, 1 parked.**

- nach `evidence_class`: 12 downstream_bridge, 19 external_data, 4 internal_consistency, 1 parked, 15 search_target
- nach `independence_group`: 4 N_star_reheating, 2 alpha_em, 1 c3_topform_horizon, 36 independent, 8 phi0_seed
