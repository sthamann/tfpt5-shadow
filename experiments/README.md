...
**Scorecard (auto-generated from `evidence_scorecard.json`): 68 Zeilen — 34 consistent, 4 tension, 10 null, 19 data_limited, 1 parked.**

- nach `evidence_class`: 15 downstream_bridge, 24 external_data, 9 internal_consistency, 1 parked, 19 search_target
- nach `independence_group`: 4 N_star_reheating, 3 alpha_em, 1 c3_topform_horizon, 2 cp_mu6_phase, 50 independent, 8 phi0_seed
