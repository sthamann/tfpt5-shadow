...
**Scorecard (auto-generated from `evidence_scorecard.json`): 94 Zeilen — 41 consistent, 7 tension, 14 null, 31 data_limited, 1 parked.**

- nach `evidence_class`: 18 downstream_bridge, 33 external_data, 9 internal_consistency, 1 parked, 33 search_target
- nach `independence_group`: 4 N_star_reheating, 4 alpha_em, 1 c3_topform_horizon, 2 carrier_ps_so10_uv_branch, 2 cp_mu6_phase, 68 independent, 2 koide_q_pole, 2 nu_mass_floor, 9 phi0_seed
