...
**Scorecard (auto-generated from `evidence_scorecard.json`): 103 Zeilen — 46 consistent, 9 tension, 15 null, 32 data_limited, 1 parked.**

- nach `evidence_class`: 20 downstream_bridge, 38 external_data, 9 internal_consistency, 1 parked, 35 search_target
- nach `independence_group`: 4 N_star_reheating, 4 alpha_em, 1 c3_topform_horizon, 2 carrier_ps_so10_uv_branch, 2 cp_mu6_phase, 72 independent, 2 koide_q_pole, 2 nu_mass_floor, 14 phi0_seed
