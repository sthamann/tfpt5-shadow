...
**Scorecard (auto-generated from `evidence_scorecard.json`): 84 Zeilen — 37 consistent, 5 tension, 13 null, 28 data_limited, 1 parked.**

- nach `evidence_class`: 17 downstream_bridge, 28 external_data, 9 internal_consistency, 1 parked, 29 search_target
- nach `independence_group`: 4 N_star_reheating, 3 alpha_em, 1 c3_topform_horizon, 2 carrier_ps_so10_uv_branch, 2 cp_mu6_phase, 63 independent, 9 phi0_seed
