...
| `pulsar-glitch-recovery/` | **Fehlende Cross-Domain-Säule** (problem_1.txt): derselbe Kernel `{1,(2/3)⁶,(1/3)⁶}` wie FRB.02/09 + GW-Echo, in echten Pulsar-Glitches (Jodrell Bank, 726 Glitches) **+ Recovery `Q`/`τ_d`** (Yu+2013, 60 Komponenten). **Sauberer Null in allen vier statischen Kanälen** (PG.01–04). **PG.05 NEU** dynamischer Recovery-Kamm (`ω=2.58`) auf echtem **Crab-`ν(t)`** (JBO-Monatsephemeride, 479 Punkte, 1988–2026): Detektor injection-validiert auf der Monatskadenz, **kein** Kern-Kamm in 7 Inter-Glitch-Segmenten → `data_limited` (Monatskadenz < ~2%-Amplitude). | aktiv |
...
**Scorecard (auto-generated from `evidence_scorecard.json`): 63 Zeilen — 32 consistent, 4 tension, 10 null, 16 data_limited, 1 parked.**

- nach `evidence_class`: 13 downstream_bridge, 21 external_data, 9 internal_consistency, 1 parked, 19 search_target
- nach `independence_group`: 4 N_star_reheating, 2 alpha_em, 1 c3_topform_horizon, 2 cp_mu6_phase, 46 independent, 8 phi0_seed
