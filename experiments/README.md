...
**Scorecard (auto-generated from `evidence_scorecard.json`): 95 Zeilen — 42 consistent, 7 tension, 14 null, 31 data_limited, 1 parked.**

- nach `evidence_class`: 19 downstream_bridge, 33 external_data, 9 internal_consistency, 1 parked, 33 search_target
- nach `independence_group`: 4 N_star_reheating, 4 alpha_em, 1 c3_topform_horizon, 2 carrier_ps_so10_uv_branch, 2 cp_mu6_phase, 68 independent, 2 koide_q_pole, 2 nu_mass_floor, 10 phi0_seed
- `alternative_group` (eine Frage, mehrere Lesarten — *nicht* doppelt zählen): 2 HVP_baseline, 2 Nstar_branch, 4 axion_branch, 3 w_de_eos
...
| **Echte Spannung** (Daten/Modell ziehen dagegen) | **θ13** (+2.0σ), **A_s** fix N⋆=51.4 (−11.3σ), g−2 unter Lattice-HVP (+3.92σ, WP2025-σ=62), Axion-**Hilltop** (~5.5× Überproduktion) | hier entscheidet sich Substanz; θ13 ist der `φ₀`-Seed-Treiber |
