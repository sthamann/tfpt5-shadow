...
targets at once. What stays \mO\ is the bridge lemma ``$\delta\log\det_\zeta(\mathrm{seam})=$ the inflow
response''; \texttt{ALPHA.QUILLEN.EXACT.01} stays \mO, and $\ainv$ stays \mE\ regardless.
\par\smallskip
