...
root. \textbf{Typing:} the determinant-line assembly and all coefficient identities are exact \mE; what stays
\emph{open} (\texttt{ALPHA.WARD.01}, \mO) is the from-first-principles AQFT proof that this is the \emph{exact}
Quillen functional of the seam $U(1)$ --- the variational principle \emph{derived}, not assembled. This is the
sharpest remaining EM-Ward obligation, and it is the honest residual of the ``why \emph{this} function'' question.
\par\smallskip
