...
residual: the from-first-principles AQFT proof that $F_{U(1)}$ is the \emph{exact} Quillen functional of the seam
$U(1)$ --- the variational principle \emph{derived}, not assembled. That is the sharpest remaining EM-Ward
obligation, unchanged in scope, now stated more sharply.
\par\smallskip
