...
sheet-twisted class, no discrete freedom left (\veri{v141\_deck\_selection.py}). What remains of the old
residual is the much smaller selector establishment R4$'$ (research contracts): derive the \emph{two}
line pairings of the torsion normal (the third is integrality-forced,
\veri{v142\_frame\_integrality.py}). \mE/\mC
\par\smallskip
