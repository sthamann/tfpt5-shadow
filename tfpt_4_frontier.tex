...
robust dominant-DM value (it lands $\Omega_a h^2$ on $\Omega_{\mathrm{DM}}$ untuned, in the mild-anharmonic
regime), while the seam hilltop $\theta_i=\pi\bigl(1-\varphi_{\mathrm{seam}}(\alpha_\star)\bigr)=170.4^\circ$
