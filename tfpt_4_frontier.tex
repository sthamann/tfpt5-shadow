...
\paragraph{Route B --- leptogenesis interface (Paper 6, \mE).} The closed branch also fixes the
...
pairing into a \emph{mechanism} (\veri{v82\_koide\_attractor\_splitting.py}). On the anchor double cover (Paper 2) the two branch points are Koide $q=2$ and carrier
...
axion} of the strong-CP sector (Paper 6, Thm.\ ``determinant-line axion interface'', \mE). Two of its
