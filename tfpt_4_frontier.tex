...
the \emph{perturbative} 4d layer is now in hand (\vref{v269}/\vref{v271}/\vref{v273}). \mO\ what remains is the one
genuine structural frontier --- the nonperturbative interacting ambient measure (the bulk projective limit), which
\mX\ closes iff the seam net $=(E_8)_1$ \emph{and} the bulk reconstruction is proved (\texttt{QGAMB.ROADMAP.01}).
\smallskip\\
