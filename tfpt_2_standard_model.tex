...
seed-hyperplane cross-validation (\vref{v306}) --- one honest pressure point, not a pattern of failures.
...
one irreducible input as $v_{\mathrm{geo}}$ (the No-Unit theorem, \vref{v153}); the dimensionless spectrum
($m_2/m_3$, the ordering, the angles) is already pinned. \mC\ the observed $m_3=\sqrt{\Delta m^2_{\mathrm{atm}}}
...
5 & Hodge gravity, metrology & $\xi=c_3/\phiz$, $v_{\mathrm{phys}}$; local field equation parameter-free (\vref{v358}/\vref{v359}), ambient measure conditional \mE/\mC \\
...
a controlled truncation. What remains are the ambient RP/measure step and the two declared inputs P1/P2 --- a
