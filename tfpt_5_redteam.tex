...
\smallskip\noindent\textbf{Target A --- the keystone residual narrowed from five further directions \mE/\mC\
...
(\veri{v448\_seam\_edge\_fourpoint.py}). \textbf{None of these promotes the keystone}: the \emph{only} thing
