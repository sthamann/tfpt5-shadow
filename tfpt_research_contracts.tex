...
\par\smallskip\noindent\textbf{Twenty-two convergent attacks on the one continuum residual --- intrinsic BW, a
...
test, the exact MMST citation audit, the complementary lattice-VOA route and the explicit flat-band
commuting-projector LTO realisation
...
\veri{v459\_seam\_lattice\_voa\_route.py}, \veri{v460\_seam\_s3\_lto.py}).} None closes
...
residual. Across (v)--(xxvii), \texttt{SEAM.EQUIV.01}
