...
\emph{R4$'$ residue \mC\ (final form):} derive the \emph{two} line pairings $(|\Z_2|,\operatorname{rank}E_8)$
--- the $\sigma$-pairing is integrality-forced; everything else in the chain anchor $\to(d,n)\to R$ is exact.
\end{keybox}
