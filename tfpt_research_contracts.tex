...
\par\smallskip\noindent\textbf{Sixteen convergent attacks on the one continuum residual --- intrinsic BW, a
...
$(E_8)_1$ torus modular data, the $\mu_4$-from-marks derivation, and the kill tests
...
\veri{v453\_seam\_mu4\_from\_marks.py}).} None closes
...
axiom-free as \texttt{FORM.SEAM.EDGE.CHERN.01}. Across (v)--(xx), \texttt{SEAM.EQUIV.01}
