...
test, the exact MMST citation audit and the complementary lattice-VOA route
...
\veri{v459\_seam\_lattice\_voa\_route.py}).} None closes
...
Across (v)--(xxvi), \texttt{SEAM.EQUIV.01}
