...
only orientability and Poincar\'e duality resist a clean machine proof --- KO-dimension $6$ forces a skew
intersection form (rank $2$, corank $1$), which the canonical hypercharge-faithful triple resolves in the
literature (\veri{v256\_orientability\_poincare.py}).
So
