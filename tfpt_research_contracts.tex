...
to the full uniformisation); \textsc{Cohom} \mE\ ($\rho^*\omega_k=i^k\omega_k$, grading
$(1,2,3)$); \textsc{Module} \mE\ (a \emph{unique} $\mu_4$-equivariant iso --- multiplicity-free $+$
residue normalisation, reflection $\omega_1\!\leftrightarrow\!\omega_3$, $\omega_2$ fixed); and
...
is. So the visible residual is one geometric postulate (\texttt{QGEO.SYM.01}), one unit gauge
