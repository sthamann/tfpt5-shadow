...
coefficient; the area-law form is established (\vref{v59}). \textbf{Residual \mO:} only (i) the linear$\to$full
non-linear covariant extension and (ii) the absolute scale $v_{\mathrm{geo}}$ (the Planck-area unit) remain ---
