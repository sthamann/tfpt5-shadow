...
linearised Einstein eq.\ & \mE/\mC & entanglement equilibrium $\delta S{=}\delta\langle K\rangle$ $\Rightarrow$ $G_{ab}{=}\cthree^{-1}T_{ab}$ \emph{parameter-free} ($8\pi{=}1/\cthree$); thermo (first law $2\pi/\eta$) $=$ geo (Gauss--Bonnet $|\Z_2|2\pi\chi$) origin of $\cthree$ via $|\mu_4|{=}|\Z_2|\chi{=}4$ (\vref{v358}); residual $=$ nonlinear $+$ $v_{\mathrm{geo}}$ \\
