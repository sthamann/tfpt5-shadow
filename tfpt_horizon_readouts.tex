...
no published search ever targeted these frequencies although they lie inside the searched RXTE band, and
the only published third-frequency structures are \emph{integer} lines ($92{=}184/2$, $34/68$\,Hz ---
pointing to the harmonic side). \texttt{experiments/hfqpo-ladder} carries the preregistered census,
selection-null Monte Carlo and the fully specified archival RXTE protocol. A search ansatz, no prediction;
even a tooth hit would be \mC\ until the mapping is derived.
