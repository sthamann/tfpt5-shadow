...
form-derivation \texttt{ALPHA.QUILLEN.EXACT.01} (\vref{v382}) and this floor are the \emph{same lever} ---
...
$\sim10^{-10}$ (\veri{v432\_overdet\_floor.py}), $\sim20$ orders above the conditional $10^{-30.7}$.}\label{fig:witness}
\end{figure}
...
Over-determination map & rhetorical ``everything multiplies'' (incl.\ \emph{our own} miscount) & \vref{v427}/\vref{v428}/\vref{v432} \\
